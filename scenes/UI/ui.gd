...
@onready var filling_soul: TextureRect = $TopLeft/StatusDetails/Frame/SoulMargin/FillingSoul
@onready var full_soul: TextureRect = $TopLeft/StatusDetails/Frame/SoulMargin/FullSoul
